    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hostelmanagement.hosteldetail')),
                ('facilities', models.ManyToManyField(to='hostelmanagement.facilities')),
                ('room', models.ManyToManyField(to='hostelmanagement.room')),
